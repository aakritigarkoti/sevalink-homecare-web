  ...
  return (
    ...
    >
      ...
      <main className="space-y-4 pt-[3.5rem] sm:pt-[4.5rem] md:pt-16">
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-base text-gray-600">
                Get professional nursing care at your home with trained and verified caregivers.
              </p>

              <ul className="mt-6 space-y-1 text-sm leading-relaxed text-gray-700">
                <li>• 24/7 availability</li>
                <li>• Certified nurses</li>
                <li>• Affordable pricing</li>
              </ul>

              <Link
                href="/select-location?service=nurse"
                className="mt-8 inline-flex rounded-lg bg-emerald-600 px-6 py-3 text-sm font-semibold !text-white visited:!text-white hover:!text-white active:!text-white transition-all duration-200 ease-in-out hover:scale-105 hover:bg-emerald-700 hover:shadow-lg"
              >
                Book Now
              </Link>
            </div>
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <Image
                ...
                alt="Professional nurse providing home care service"
                width={1200}
                height={800}
        ...
        <section className="px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mt-6 max-w-6xl rounded-2xl border border-gray-100 bg-white p-6 sm:p-8">
            <h2 className="mb-3 text-lg font-semibold text-gray-900">
              Starting from <span className="font-extrabold">₹499 per visit</span>
            </h2>
            <p className="mt-2 text-sm text-gray-500">
              Final pricing may vary based on service type
            </p>
          </div>
        </section>
