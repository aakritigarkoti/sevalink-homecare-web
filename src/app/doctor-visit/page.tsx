          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-base text-gray-600">
                Book qualified doctors for home consultations with convenient scheduling and trusted care.
              </p>
              ...
              <Link
                href="/select-location?service=doctor-visit"
        ...
        <section className="px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mt-6 max-w-6xl rounded-xl bg-gray-50 p-5">
            <h2 className="mb-3 text-lg font-semibold text-gray-900">
              Starting from <span className="font-extrabold">₹599 per visit</span>
            </h2>
            <p className="text-sm text-gray-500">
              Final pricing may vary depending on consultation type
            </p>
          </div>
        </section>
