          ...
          <div className="mx-auto grid max-w-6xl items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mt-2 text-base text-gray-600">
                Access compassionate mental health support and therapy sessions from home.
              </p>
              ...
              <Link
                href="/select-location?service=mental-health"
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-gray-50 shadow-md transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
              <Image
                ...
                alt="Mental health counseling support at home"
                width={1200}
                height={800}
        ...
        <section className="px-4 sm:px-6 lg:px-8">
          <div className="mx-auto mt-6 max-w-6xl rounded-xl bg-gray-50 p-5">
            <h2 className="mb-3 text-lg font-semibold text-gray-900">
              Starting from <span className="font-extrabold">₹699 per session</span>
            </h2>
            <p className="text-sm text-gray-500">
              Final pricing may vary depending on support requirements
            </p>
          </div>
        </section>
